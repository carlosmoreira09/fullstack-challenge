...
export class CreateTasksTable190000 implements MigrationInterface {
    name = 'InitTasks1700020000000'
    ...
    `);
        ...
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_comments_task" ON "comments" ("task_id");`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_assignments_task" ON "assignments" ("task_id");`);
        await queryRunner.query(`CREATE INDEX IF NOT EXISTS "IDX_history_task" ON "task_history" ("task_id");`);
    }
