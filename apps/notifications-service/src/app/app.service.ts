...
import {CreateNotificationsDto, NotificationStatus, NotificationType, Task} from "@taskmanagerjungle/types";
...
export class AppService {
    ...
    async create(notificationData: CreateNotificationsDto) {
        const createNotification = this.notifcationsRepository.create(notificationData)
        const createdNotification = await this.notifcationsRepository.save(createNotification)
        this.notificationsGateway.emitNotification(createdNotification.userId, createdNotification);
