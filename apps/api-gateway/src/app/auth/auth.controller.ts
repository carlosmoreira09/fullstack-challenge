...
export class AuthController {
    ...
    @ApiResponse({ status: 200, description: 'Login successful', schema: { example: { accessToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...', refreshToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...', user: { id: '123e4567-e89b-12d3-a456-426614174000', username: 'john.doe', email: 'john@example.com' } } } })
    ...
    @Post('validate')
    @ApiOperation({ summary: 'Validate token', description: 'Validate user credentials/token' })
    @ApiBody({ type: LoginDTO })
    ...
    @ApiResponse({ status: 200, description: 'Token refreshed successfully', schema: { example: { accessToken: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9...' } } })
